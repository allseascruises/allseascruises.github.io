...
$(document).ready(function(){
    ...
    $('#BrowseModal').on('shown.bs.modal', function (e) {
        $("#luxury").css('background-image', "url(/img/luxury.jpg)");
        $("#caribbean").css('background-image', "url(/img/caribbean.jpg)");
        $("#europe").css('background-image', "url(/img/europe.jpg)");
        $("#alaska").css('background-image', "url(/img/alaska.jpg)");
        $("#exotic").css('background-image', "url(/img/exotic.jpg)");
    })
});
